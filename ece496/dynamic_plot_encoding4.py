...
def animate(i):
    encoding_data = open('./out/encoding3.csv','r').read()
    ...
    two_d_cpu_encoding = two_dimensional_form.reshape((20,20))
    ax1.clear()
    ax1.set_title("feature encoding 4: CPU Usage Encoding (SDR)")
